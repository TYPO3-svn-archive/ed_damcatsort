...
class Tx_EdDamcatsort_Domain_Repository_DamCategoryRepository extends Tx_Extbase_Persistence_Repository {
	 ...
	 * @return void
	 */
	public function injectQuerySettings(Tx_Extbase_Persistence_QuerySettingsInterface $querySettings) {
